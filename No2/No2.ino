...
const float Sf1 = -22.07; //nA/ppm change this to match your barcode!!!!   ***SO2 = 42.47   NO2 = -22.07
...
void loop() {
  ...
  if (millis() - etime > (s * 1000)) {//also handles case where millis rolls over, but may cause timing issue.
    ...
    // Serial.print(", ");
    Serial.println(sensor1.convertX('B')); //use 'M' or 'B' for units or Serial.println(sensor1.pX); to just print ppb
